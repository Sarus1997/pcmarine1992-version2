        ...
        <div class="content">
            <div class="container">
                <div class="card first">
                    <img src="assets/img/news/pce-new-02.webp" width="100%">
                    <h2 style="color: #2D4981">@lang('messages.News_Head_02')</h2>
                    <p class="date">@lang('messages.News_Date_02')</p>
                    <hr>
                    <p class="text" style="text-align: justify">@lang('messages.News_Detail_02')</p>
                </div>
            </div>
        </div>
    </div>
